...
var ServerInformation = {
    POIDATA_SERVER: "http://api.map.baidu.com/place/v2/search",
...
var World = {
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
		...
		for (var currentPlaceNr = 0; currentPlaceNr < poiData.length; currentPlaceNr++) {
			var singlePoi = {
                "id": poiData[currentPlaceNr].uid,
                "latitude": parseFloat(poiData[currentPlaceNr].location.lat),
                "longitude": parseFloat(poiData[currentPlaceNr].location.lng),
                "altitude": parseFloat(poiData[currentPlaceNr].altitude),
                "title": poiData[currentPlaceNr].name,
                "distance":poiData[currentPlaceNr].detail_info.distance,
                "telephone":poiData[currentPlaceNr].telephone,
	...
	*/
	...
	getPoiInfo: function getPoiInfo(){
		document.getElementById("searchinfo");
		World.search_info=searchinfo.value;
		document.getElementById("rangeinfo");
		World.range_info=rangeinfo.value*1000;
		World.reloadPlaces();
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		//Input baidu map api key here
		var serverUrl = "https://api.map.baidu.com/place/v2/search?q="+World.search_info+"&page_size=20&radius="+World.range_info+"&scope=2&location="+lat+","+lon+"&coord_type=1&output=json&ak=INPUT_BAIDU_API_KEY_HERE&s=1";
