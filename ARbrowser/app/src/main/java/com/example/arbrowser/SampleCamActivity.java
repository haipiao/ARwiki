...
public class SampleCamActivity extends AbstractArchitectCamActivity {
	...
	public String getARchitectWorldPath() {
		...
		return "browsingPois" + File.separator + "index.html";
	}

	@Override
	public String getActivityTitle() {

		 return "AR Browser World";
	}
		...
		return new ArchitectUrlListener() {
			...
			public boolean urlWasInvoked(String uriString) {
				...
				if ("markerselected".equalsIgnoreCase(invokedUri.getHost())) {
					...
					poiDetailIntent.putExtra(SamplePoiDetailActivity.EXTRAS_KEY_POI_TELE, String.valueOf(invokedUri.getQueryParameter("telephone")) );
